...
function SidebarLink({ item, isActive }: { item: NavItem; isActive: boolean }) {
  return (
    ...
    >
      ...
      {item.badge && (
        <span className="text-xs bg-blue-500/20 text-blue-300 px-2 py-0.5 rounded-full">{item.badge}</span>
      )}
    </Link>
  );
}
    ...
    <AuthGuard>
      <div className="flex h-screen bg-gray-950 overflow-hidden">
        ...
        <aside
          className={`${
            collapsed ? "w-16" : "w-64"
          } flex-shrink-0 bg-gray-900 border-r border-white/5 flex flex-col transition-all duration-200`}
        >
          {/* Logo */}
          <div className="px-4 py-5 border-b border-white/5">
            <div className="flex items-center gap-3">
              ...
              {!collapsed && (
                <div>
                  <p className="text-sm font-bold text-white tracking-tight">UIG Pipeline</p>
